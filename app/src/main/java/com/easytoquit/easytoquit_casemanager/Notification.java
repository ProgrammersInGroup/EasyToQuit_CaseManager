...
public class Notification {
    ...
    *//**
    ...
    public static void showNotificationProgress(Context context) {
        ...
        final android.app.Notification notification = builderProgress.build();
...
*/
    ...
    public static void showFullScreen(Context context){
        ...
        builder.setContentTitle("請重新填寫評估資料唷！");
        //設置點擊跳轉
    ...
    /*public static void shwoNotify(Context context) {
        ...
        mBuilder.setContent(view_custom)
                ...
                .setTicker("有新资讯")
                .setPriority(android.app.Notification.PRIORITY_HIGH)// 设置该通知优先级
